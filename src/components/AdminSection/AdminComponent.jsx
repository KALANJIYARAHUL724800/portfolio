    ...
    <div className="container d-flex justify-content-center align-items-center" style={{ minHeight: "100vh" }}>
      <div className="col-md-4">
        <form className="form text-center p-4 shadow rounded bg-light" onSubmit={formSubmit}>
          ...
          <input type="text" name="username" id="username" placeholder="Enter the name" className="form-control mb-3" value={data.username} onChange={handleChange} />

          <label htmlFor="password" className="form-label">Admin Password</label>
          <input type="password" name="password" id="password" placeholder="Enter the password" className="form-control mb-3" value={data.password} onChange={handleChange} />
